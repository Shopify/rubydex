...
// Graph#complete_expression: (Array[String] nesting) -> Array[Declaration | Keyword | KeywordArgument]
...
// Graph#complete_namespace_access: (String name) -> Array[Declaration | Keyword | KeywordArgument]
...
// Graph#complete_method_call: (String name) -> Array[Declaration | Keyword | KeywordArgument]
...
// Graph#complete_method_argument: (String name, Array[String] nesting) -> Array[Declaration | Keyword | KeywordArgument]
