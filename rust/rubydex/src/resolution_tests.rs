...
mod visibility_resolution_tests {
    ...
    #[test]
    fn initialize_inside_singleton_class_is_public() {
        let mut context = graph_test();
        context.index_uri(
            "file:///foo.rb",
            r"
        ...
        assert_no_diagnostics!(&context);
        assert_visibility_eq!(context, "Foo::<Foo>#initialize()", Visibility::Public);
        assert_visibility_eq!(context, "Foo::<Foo>#respond_to_missing?()", Visibility::Public);
    }

    #[test]
    fn module_function_initialize_defines_public_singleton_and_private_instance_methods() {
        let mut context = graph_test();
        context.index_uri(
            "file:///foo.rb",
            r"
    ...
    #[test]
    fn retroactive_public_overrides_implicit_private_initialize() {
        let mut context = graph_test();
        context.index_uri(
            "file:///foo.rb",
            r"
